  ...
  setView: function (view) {
    switch (view) {
      ...
      case "disliked":
        ...
        break;
      case "createDog":
        var component = React.createElement(createDog, { setView: this.setView});
        break
      case "preferences":
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    "li",
                    { className: this.state.viewName == "createDog" ? "current-tab" : "" },
                    React.createElement(
                      "a",
                      { onClick: this.setView.bind(this, "createDog") },
                      "Add Dog +"
                    )
                  ),
                  React.createElement(
