  ...
  setView: function(view) {
    switch(view) {
      ...
      case "disliked":
        ...
        break;
      case "createDog":
        var component = <createDog setView={this.setView}/>;
        break;
      case "preferences":
            ...
            <div className="circle--fluid">
              ...
              <div className="circle--fluid--cell circle--fluid--secondary">
                <nav disabled={this.state.view == ""}>
                  <ul className="circle--inline">
                    <li className={this.state.viewName == "createDog"? "current-tab" : "" }>
                      <a onClick={this.setView.bind(this, "createDog")}>Add Dog +</a>
                    </li>
